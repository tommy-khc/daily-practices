...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        this.primaryStage.getIcons().add(new Image("file:AddressApp/resources/images/iconfinder_Address_Book_86957.png"));
    ...
    public boolean showPersonEditDialog(Person person) {
        try {
            ...
            dialogStage.getIcons().add(new Image("file:AddressApp/resources/images/iconfinder_Address_Book_86957.png"));
